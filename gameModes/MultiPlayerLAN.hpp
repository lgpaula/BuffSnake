#ifndef SNAKE_MULTIPLAYERLAN_HPP
#define SNAKE_MULTIPLAYERLAN_HPP
...
class MultiPlayerLAN : public GameMode {

public:
    MultiPlayerLAN(int playersOnLan, Helper::Size dimension, OnGameOverMP onGameOver, OnConsumableConsumedMP onConsumableConsumed,
                   OnLifeIncrease onLifeIncrease, OnLifeDecrease onLifeDecrease);

    ~MultiPlayerLAN() override;
...
#endif //SNAKE_MULTIPLAYERLAN_HPP
